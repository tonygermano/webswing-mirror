(function ($) {
    ...
    /*-------------------------------------
     jQuery MeanMenu
     -------------------------------------*/
    $('nav#dropdown').meanmenu({siteLogo: "<a href='single.html'><img src='img/logo.png' /></a>"});
    ...
    $('#TableOfContents ul li ul').unwrap();
    $('#TableOfContents ul ul').unwrap();
    $('#TableOfContents ul').addClass('alul');
})(jQuery);