...
public class ConfigMsgOut implements SyncMsg, MsgOut {
	...
	public ConfigMsgOut(byte[] serverConfig, String serverError, List<AppConfigMsgOut> appConfigs, String correlationId) {
		super();
