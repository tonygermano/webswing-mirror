...
public class WindowHierarchyTree {
    ...
    LinkedList<WindowHierarchyNode> alwaysOnTopZOrder = new LinkedList<WindowHierarchyNode>();
    LinkedList<WindowHierarchyNode> regularZOrder = new LinkedList<WindowHierarchyNode>();
    LinkedList<WindowHierarchyNode> zOrder = new LinkedList<WindowHierarchyNode>();
    ...
    protected Window getVisibleWindowOnPosition(int x, int y) {
        for (WindowHierarchyNode w : zOrder) {
