...
public class MyWrapperdGraphics extends Graphics2D {
    ...
    public MyWrapperdGraphics(BufferedImage img) {
        this.img = img;
    ...
    @Override
    public void dispose() {
//        if (PaintManager.isForceDoubleBufferedPainting()) {
//            Rectangle bounds = getClip().getBounds();
//            BufferedImage result = new BufferedImage((int) bounds.getWidth(), (int) bounds.getHeight(), BufferedImage.TYPE_INT_ARGB_PRE);
//            Graphics rg = result.getGraphics();
//            rg.drawImage(img.getSubimage(bounds.x, bounds.y, bounds.width, bounds.height), 0, 0, null);
//            rg.dispose();
//            PaintManager.directPaintToWeb(result, (int) lastTranslateX, (int) lastTranslateY);
//        }
        g.dispose();
    }
