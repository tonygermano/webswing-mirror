define([ 'jquery', 'webswing-base', 'atmosphere', 'ProtoBuf', 'bootstrap', 'jquery.iframe-transport', 'jquery.fileupload' ], function($, webswingBase, atmosphere,ProtoBuf) {
	"use strict";
	...
	var config = {
		...
		onApplicationShutdown : function() {
			showDialog(messageDialog, 'Application stopped... <br\> <button class="btn btn-primary" onclick="webswing.continueSession(false)">Start new session.</button>' + '<span> </span><button class="btn btn-default" onclick="window.location.href = \'/logout\'">Logout.</button>');
			atmosphere.unsubscribe();
		},
