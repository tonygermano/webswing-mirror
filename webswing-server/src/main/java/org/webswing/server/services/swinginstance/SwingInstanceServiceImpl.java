...
public class SwingInstanceServiceImpl implements SwingInstanceService {
	...
	@Override
	public SwingInstance create(SwingInstanceManager manager, FileTransferHandler fileHandler, ConnectionHandshakeMsgIn h, SwingDescriptor config, WebSocketConnection r) throws WsException {
